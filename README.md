...
![Tela Principal](screenshots/telaprincipal_0.png)

- Cadastro de Produto

![Exemplo de um Produto sendo cadastrado](screenshots/telaprincipal_1.png)
![Janela de confirmação de cadastro](screenshots/telaprincipal_2.png)

- Pesquisa de um produto

![Pesquisa de um produto](screenshots/telaprincipal_3.png)

- Pesquisa de um produto por categoria

![Pesquisa por categoria](screenshots/telaprincipal_6.png)

- Alteração de preço de um produto

![Produto sendo alterado](screenshots/telaprincipal_4.png)

- Exemplo exclusão de um produto

![Tela Principal](screenshots/telaprincipal_5.png)
